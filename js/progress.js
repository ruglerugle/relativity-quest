...
(function (global) {
  ...
  var STAGES = [
    ...
    { n: 6, file: "stage6.html", title: "E=mc²", sub: "質量とエネルギーの関係" },
    { n: 7, file: "stage7.html", title: "重力は空間のゆがみ", sub: "一般相対性理論への入り口" },
    { n: 8, file: "stage8.html", title: "身近な相対性理論", sub: "ブラックホールとGPS" }
  ];
